...
String sql ="SELECT * FROM iplog WHERE out_country='Australia(AU)'";
...
%>
  ...
  int indnum=0;
   ...
   try{
        ...
        ResultSet rs3 = st.executeQuery("SELECT COUNT(out_country) AS count FROM iplog WHERE out_country='Australia(AU)'");
 ...
 int nonindnum=0;
       try{
        Statement st1 = connection.createStatement();
            ...
            ResultSet rs4 = st1.executeQuery("SELECT COUNT(out_country) AS count2 FROM iplog WHERE NOT out_country='Australia(AU)' ");
